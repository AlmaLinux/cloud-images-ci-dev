...
#
# Usage:
#   tools/gencloud-build-test.sh [-v <MAJOR>] [-y]
#
# Options:
...
usage() {
  cat <<'EOF'
Usage: tools/gencloud-build-test.sh [-v <MAJOR>] [-y]
...
confirm "Dispatch gencloud-build.yml (version_major=${VERSION_MAJOR}, defaults for self-hosted/store_as_artifact/upload_to_s3/notify_mattermost)?" \
  || die "Aborted by user."
